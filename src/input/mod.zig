...
pub const InputSourceKind = events.InputSourceKind;
pub const InputSource = events.InputSource;
pub const InputEventKind = events.InputEventKind;
pub const DigitalActionEvent = events.DigitalActionEvent;
pub const Axis1ActionEvent = events.Axis1ActionEvent;
pub const Axis2ActionEvent = events.Axis2ActionEvent;
